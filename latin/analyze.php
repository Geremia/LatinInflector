...
<body>
  ...
  <h3><span id="status"></span></h3><?php
              function printFloatBox($word){ 
                      ...
                      $xmlString = file_get_contents("http://services.perseids.org/bsp/morphologyservice/analysis/word?lang=lat&engine=morpheuslat&word=".$wordForPerseus) or die('<script type="text/javascript">document.getElementById("status").innerHTML=\'<font color="red">Cannot reach Perseus server</font>\';</script>');
